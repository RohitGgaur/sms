               ...
               <div className="teacher-profile">
                   <div className="row">
                       ...
                       >
                           ...
                           <div className="contant mt-1 text-center" style={{ fontSize: "14px", color: "black",fontWeight:"bold" }}>
                   ...
                   >
                       ...
                       <div className="contant" style={{ position: 'absolute', top: '80px' }}>
                           <div className="row1" style={{ gap: "640px", display: "flex" }}>
                               <div className="column-lg-3">
                                   <span style={{ color: "black", fontSize: "17px", fontWeight: "bold" }}>Faculty Id-</span>
                                   <span style={{ color: "black", fontSize: "17px",marginLeft:"25px" }}>{data.id}</span>
                               </div>
                               <div className="column-lg-3">
                                   <span style={{ color: "black", fontSize: "17px", fontWeight: "bold" }}>Experince.-</span>
                                   <span style={{ color: "black", fontSize: "17px",marginLeft:"25px" }}>{data.experince}</span>
                               </div>
                           </div>
                           <div className="row1 mt-4" style={{ gap: "580px", display: "flex" }}>
                               ...
                               <div className="column-lg-3">
                                   <span style={{ color: "black", fontSize: "17px", fontWeight: "bold" }}>Department Name-</span>
                                   <span style={{ color: "black", fontSize: "17px",marginLeft:"25px" }}>{data.department}</span>
                               </div>
                           </div>
                           <div className="row1 mt-4" style={{ gap: "614px", display: "flex" }}>
                               <div className="column-lg-3">
                                   <span style={{ color: "black", fontSize: "17px", fontWeight: "bold" }}>Higher Degree-</span>
                                   <span style={{ color: "black", fontSize: "17px",marginLeft:"25px" }}>{data.higheredu}</span>
                               </div>
                               <div className="column-lg-2">
                                   <span style={{ color: "black", fontSize: "17px", fontWeight: "bold" }}>Position-</span>
                                   <span style={{ color: "black", fontSize: "17px",marginLeft:"10px" }}>{data.position}</span>
                               </div>
                           </div>
                           <div className="row1 mt-4" style={{ gap: "614px", display: "flex" }}>
                               <div className="column-lg-3">
                                   <span style={{ color: "black", fontSize: "17px", fontWeight: "bold" }}>Total Researchpaper-</span>
                                   <span style={{ color: "black", fontSize: "17px",marginLeft:"25px" }}>{data.researchpaper}</span>
                               </div>
                               <div className="column-lg-3">
                                   <span style={{ color: "black", fontSize: "17px", fontWeight: "bold" }}>Degree-</span>
